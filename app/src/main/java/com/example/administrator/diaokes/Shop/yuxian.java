...
public class yuxian extends Fragment implements OnBannerListener {
    ...
    private shopitem[] shopitems = {new shopitem(R.drawable.yuxian1,"中海鱼线",6),new shopitem(R.drawable.yuxian4,"黄奕鱼线",4),new shopitem(R.drawable.yuxian6,"亦云鱼线",6),
            new shopitem(R.drawable.yuxian2,"古香鱼线",9),new shopitem(R.drawable.yuxian3,"北忞鱼线",1),new shopitem(R.drawable.yuxian5,"南海鱼线",9)};
    @Nullable
    @Override
    ...
    private void inits(){
        ...
        list_path.add(R.drawable.yuxian2);
