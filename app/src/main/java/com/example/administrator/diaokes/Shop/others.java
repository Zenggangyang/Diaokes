...
public class others extends Fragment implements OnBannerListener {
    ...
    private shopitem[] shopitems = {new shopitem(R.drawable.peijian1,"中海配件",16),new shopitem(R.drawable.peijian4,"黄奕配件",24),new shopitem(R.drawable.peijian6,"亦云配件",36),
            new shopitem(R.drawable.peijian2,"古香配件",19),new shopitem(R.drawable.peijian3,"北忞配件",10),new shopitem(R.drawable.peijian5,"南海配件",90)};
    @Nullable
    @Override
    ...
    private void inits(){
        ...
        list_path.add(R.drawable.peijian2);
        list_path.add(R.drawable.peijian3);
        list_path.add(R.drawable.peijian5);
