...
public class erliao extends Fragment implements OnBannerListener {
    ...
    private shopitem[] shopitems = {new shopitem(R.drawable.yuer1,"万兴饵料",16),new shopitem(R.drawable.yuer4,"龙王恨",24),new shopitem(R.drawable.yuer5,"亦云饵料",36),
            new shopitem(R.drawable.yuer2,"中海饵料",19),new shopitem(R.drawable.yuer3,"森源饵料",20),new shopitem(R.drawable.yuer6,"西部风饵料",90)};
    @Nullable
    @Override
    ...
    private void inits(){
        ...
        list_path.add(R.drawable.yuer1);
        list_path.add(R.drawable.yuer3);
        list_path.add(R.drawable.yuer2);
        list_path.add(R.drawable.yuer5);
