...
public class yugou extends Fragment implements OnBannerListener{
    ...
    private shopitem[] shopitems = {new shopitem(R.drawable.yugou1,"万兴鱼钩",16),new shopitem(R.drawable.yugou4,"黄奕渔具",24),new shopitem(R.drawable.yugou2,"亦云鱼钩",36),
            new shopitem(R.drawable.yugou2,"ACG鱼钩",19),new shopitem(R.drawable.yugou3,"东美鱼钩",10),new shopitem(R.drawable.yugou5,"南海鱼钩",90)};
    @Nullable
    @Override
    ...
    private void inits(){
        ...
        list_path.add(R.drawable.yugou1);
        list_path.add(R.drawable.yugou2);
        list_path.add(R.drawable.yugou5);
